...
- **EvalPro.UI** — WPF frontend (namespace `EvalProUI`, targets `net9.0-windows`). Cannot be built/run on macOS.
...
- The service class is the sole entry point for all business operations — the UI should never access `ServiceData` directly.
